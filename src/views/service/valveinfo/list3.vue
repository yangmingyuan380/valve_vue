    ...
    <el-form :model="基本信息" :rules="基本信息rules" ref="基本信息" label-position="center" label-width="120px" size="mini">
      ...
      <div class="cell">
        <div class="container">
          ...
          <el-row>
            <el-col :span="7">
              <el-form-item label="姓名" prop="认定人姓名" style="width: 300px">
                <el-input v-model="认定.姓名" controls-position="right" :min="0"/>
              </el-form-item>
            </el-col>
            <el-col :span="4">
              <el-form-item label="工作单位及职务(职称)" prop="认定人工作单位及职务">
                <el-input v-model="认定.工作单位及职务" style="width: 300px" controls-position="right" :min="0"/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-input type="textarea" :rows="10"  placeholder="请输入审核中发现的有关问题及审核意见" v-model="认定.单位审核意见"
                    style="margin-left: 100px; width: 1000px;"></el-input>
        </div>
      </div>
      <div class="mybottom">
        <el-form-item style="margin:10px 10px 10px 400px">
          <el-button type="primary" @click="saveOrUpdate" style="margin:10px 10px 10px 0px">提交</el-button>
